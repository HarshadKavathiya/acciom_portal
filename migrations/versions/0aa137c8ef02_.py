...
Revision ID: 0aa137c8ef02
Revises: 
Create Date: 2019-01-09 23:35:35.744113
...
def upgrade():
    ...
    sa.Column('test_queries', sa.String(length=80), nullable=True),
    ...
    sa.Column('src_execution_log', sa.Text(), nullable=True),
    sa.Column('des_execution_log', sa.Text(), nullable=True),
